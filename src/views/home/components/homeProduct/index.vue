                        ...
                        <v-col cols="2">
                            <v-img :src="product.picture" cover style="height: 100%;">
                                <div class="d-flex align-center justify-start fill-height">
                                    <span class="text-white px-2 py-5" style="background-color: rgba(0, 0, 0, 0.7);">{{ product.name + '馆' }}</span>
                                    <span class="text-white px-2 py-5" style="background-color: rgba(0, 0, 0, 0.4);">{{ product.saleInfo }}</span>
                                </div>
                            </v-img>
                        </v-col>
                        <v-col cols="10">
                            <v-row align="stretch" justify="center">
                                <template v-for="good in product.goods" :key="good.id">
                                    <v-col cols="3">
                                        ...
                                        :name="good.name"
                                        :desc="good.desc"
                                        :price="good.price"></GoodsItemCard>
                                        <!-- <v-card variant="flat">
